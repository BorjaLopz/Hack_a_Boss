...
/* Seleccionamos el nombre, apellido y numero de telefono de la tabla students y los ordenamos por su apellido */
SELECT name, surname, phone_number
FROM students
ORDER BY surname;


/* seleccionamos el pais y contamos (resultado en amount) de la tabla addresses y agrupamos por country */
