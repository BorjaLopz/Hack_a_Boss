...
/*Copia todo el código del ejercicio anterior (incluyendo el proporcionado y tu solución) y añade el SQL necesario para seleccionar 
el nombre y la edad de el usuario con mayor edad (o los usuarios si hay empate). Para ello tienes que usar subconsultas (…y una pista: la función max de SQL).*/
